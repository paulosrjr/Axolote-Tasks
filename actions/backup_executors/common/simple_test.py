...
class SimpleTest(celery_app.Task):
    """
    Execute a async Simple Test
    """
    def __init__(self):
        self.name = "actions.backup_executors.common.simple_test"
        self.message = ""
    ...
    def run(self, **kwargs):
        print("Async Simple Test")
        return True


celery_app.register_task(SimpleTest())
